...
def one_disease(disease=1):
    ...
    pathpar = '/public/bme/home/meilang/codes/ECR/BRAIN_AGE_ESTIMATION_CONFERENCE'
    # pathpar = '/public/bme/home/zhaonan/brain_age_est/codes/BRAIN_AGE_ESTIMATION_CONFERENCE' # path to BRAIN_AGE_ESTIMATION
    data_csv = "/public_bme/share/sMRI/csv/ECR/subinfo_BDs_dive_DK106_new.csv" # path to data
    outpath =os.path.join(pathpar, 'OUTPUT') 
    if not os.path.exists(outpath):
        os.mkdir(outpath)   

    args.parsave = "threedim_3view_GAF-20230811-153250_p"
    args.parsave = os.path.join(outpath, args.parsave)

    testpath = os.path.join(args.parsave, "TEST_ECR")
